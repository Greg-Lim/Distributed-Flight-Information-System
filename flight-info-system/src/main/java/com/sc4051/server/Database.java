...
public class Database {
    ...
    private static void setup(){
        allFlights.add(new FlightInfo(1010, "SIN", "NRT", new DateTime(2023,1,1,1,15), 600, 3));
    ...
    public void notifyFlight(int id, ClientInfo client) throws NoSuchFlightException{
